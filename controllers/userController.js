...
class UserController  {
    ...
    static registerUser = async (req, res) => {
       ...
       if(!(userDetails.email && userDetails.password && userDetails.name && userDetails.phoneNumber))
       ...
       try {
           ...
           let userDb = UserModel({phoneNumber:userDetails.phoneNumber, name:userDetails.name, email:userDetails.email, passwordHash})
           ...
           //asynchroneously send verification message
